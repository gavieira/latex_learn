...
You can also cite certain parts of your text with the \verb+\cite{}+ command. Of course, you will need a .bib file in order to do that.

I will cite some articles here. \cite{Almeida2019, Prosdocimi2007}

You will also need to use the following commands to print the references:

\begin{lstlisting}
	\bibliography{path_to_bibliography_file}
	\bibliographystyle{wanted_bib_style}	
\end{lstlisting}
